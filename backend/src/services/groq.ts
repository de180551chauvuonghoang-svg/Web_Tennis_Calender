...
3. startTime: Thời gian bắt đầu buổi tập (Định dạng chuỗi ISO: YYYY-MM-DDTHH:mm:ss.000Z). Bạn cần phân tích kỹ mốc thời gian HLV ghi (ví dụ: "3h30pm", "4:00 chiều", "sáng mai", "tối thứ 5"). Kết hợp với ngày hiện tại (${currentDateStr}) để quy đổi ra thời gian chính xác ở múi giờ Việt Nam (GMT+7, chuyển sang ISO UTC để lưu vào database).
4. duration: Thời lượng buổi tập tính bằng phút (dạng số, ví dụ "1h" = 60, "1h30p" = 90, "2h" = 120. Mặc định là 90).
5. court: Tên sân tập (ánh xạ chính xác sang 1 trong 2 giá trị sau: "Hào Anh tennis Coffee" hoặc "Sân Victoria resort"). Nếu không xác định rõ, mặc định chọn "Hào Anh tennis Coffee".
